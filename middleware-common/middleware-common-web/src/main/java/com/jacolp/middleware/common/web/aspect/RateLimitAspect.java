package com.jacolp.middleware.common.web.aspect;
...
public class RateLimitAspect {
    ...
    @Pointcut("@annotation(com.jacolp.middleware.common.web.annotation.RateLimit) || "
            + "@annotation(com.jacolp.middleware.common.web.annotation.RateLimits)")
