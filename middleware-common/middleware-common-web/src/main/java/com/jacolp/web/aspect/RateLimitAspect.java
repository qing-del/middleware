...
import com.jacolp.web.annotation.RateLimits;
...
public class RateLimitAspect {
    ...
    @Pointcut("@annotation(com.jacolp.web.annotation.RateLimit) || "
            + "@annotation(com.jacolp.web.annotation.RateLimits)")
