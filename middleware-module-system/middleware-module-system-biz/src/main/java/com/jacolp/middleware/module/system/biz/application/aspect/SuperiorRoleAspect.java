...
/**
 * 切面：对标注了 {@link com.jacolp.middleware.module.system.biz.application.annotation.RequireSuperiorRole} 的方法做权限前置校验。
 * <p>
 * 校验规则：
 * <ol>
...
public class SuperiorRoleAspect {
    ...
    @Before("@annotation(com.jacolp.middleware.module.system.biz.application.annotation.RequireSuperiorRole)")
