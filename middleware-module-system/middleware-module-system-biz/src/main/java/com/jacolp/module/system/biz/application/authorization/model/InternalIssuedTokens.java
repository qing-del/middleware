...
public record InternalIssuedTokens(String accessToken, String refreshToken, String tokenType, Instant accessIssuedAt,
    ...
    @Override public String toString() { return "InternalIssuedTokens[accessToken=<redacted>, refreshToken=<redacted>, scopes=" + grantedScopes.size() + "]"; }
