...
public record InternalLoginRequest(String clientId, String grantType, String username, String rawPassword,
    ...
    public InternalLoginRequest {
        ...
        if ("password".equals(grantType)) {
            if (!text(username) || !text(rawPassword) || username.length() > 100 || email != null || rawEmailCode != null) {
                throw new IllegalArgumentException("Invalid internal login request");
            }
        } else {
